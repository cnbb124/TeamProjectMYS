...
Shader "FORGE3D/WarpJumpTunnel_New"
{
    ...
    SubShader
    {
        ...
        void surf(Input i, inout SurfaceOutput o)
        {
            ...
            float4 lerpResult10 = lerp((_TintColorA * _TintColorA.a * _Mult), (_TintColorB * _TintColorB.a * _Mult),
                                       (_Mult * tex2DNode7).r);
            float4 ase_screenPos = float4(i.screenPos.xyz, i.screenPos.w + 0.00000000001);
            float4 ase_screenPosNorm = ase_screenPos / ase_screenPos.w;
            ase_screenPosNorm.z = (UNITY_NEAR_CLIP_VALUE >= 0) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
            float screenDepth13 = LinearEyeDepth(
            ...
            o.Emission = (lerpResult10 * tex2DNode7 * i.vertexColor * i.vertexColor.a * saturate(distanceDepth13) *
                _Alpha).rgb;
            o.Alpha = 1;
        }
        ENDCG
