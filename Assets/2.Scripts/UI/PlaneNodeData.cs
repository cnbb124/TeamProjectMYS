...
public class PlaneNodeData : ScriptableObject
{
    ...
    [Range(0, 500)] public int shield;
    [Range(0, 300)] public int armor;
    [Range(0, 500)] public int speed;
    [Range(0, 1000)] public int boost;
    [Range(0, 300)] public int mobility;
    [Range(0, 300)] public int stability;
    [Range(0, 300)] public int airToAir;
    [Range(0, 300)] public int airToGround;
