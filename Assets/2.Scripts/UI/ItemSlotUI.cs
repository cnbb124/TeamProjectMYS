...
public class ItemSlotUI : MonoBehaviour
{
    ...
    public class Slot
    {
        public Image        background;   // ?¨Î°Ø Î∞∞Í≤Ω
        public Image        weaponIcon;   // Weapon_0X Image
        public GameObject   indicator;    // ItemIndicator (?úÏÑ±??ÎπÑÌôú?±Ìôî)
        public TMP_Text     numberText;   // ?¨Î°Ø Î≤àÌò∏
        public Sprite       weaponSprite; // ?†Îãπ??Î¨¥Í∏∞ ?ÑÏù¥ÏΩ?
    }
    ...
    public void SelectSlot(int index)
    {
        ...
        // ?åÎ†à?¥Ïñ¥ ÎØ∏ÏÇ¨???Ä???∞Îèô (?¨Î°Ø 0~2 = equippedMissiles ?∏Îç±??
